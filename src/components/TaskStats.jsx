...
function TaskStats() {
    ...
    return (
        <div className="p-4 sm:p-6 flex flex-col items-center">
            <h1 className="text-xl sm:text-xl bg-gradient-to-r from-sky-400 via-yellow-400 to-sky-500 bg-clip-text text-transparent font-bold mb-5 sm:mb-7 text-center">
