...
function TaskStats() {
    ...
    return (
        <div className="p-4 sm:p-6 flex flex-col items-center">
            <h1 className="text-xl sm:text-2xl bg-gradient-to-r from-sky-400 via-yellow-400 to-sky-500 bg-clip-text text-transparent font-bold mb-12 sm:mb-12 text-center">
