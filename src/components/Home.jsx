    ...
    return (
        <div className="flex flex-col justify-center items-center h-screen overflow-hidden">
            <h1 className="text-4xl bg-gradient-to-r from-purple-500 via-emerald-500 to-pink-500 bg-clip-text text-transparent font-bold mb-6">
                Bienvenue sur Infinitix Blog
            </h1>
            <button
                onClick={handleClick}
                className="bg-gradient-to-r from-pink-500 to-purple-500 via-teal-500 text-black px-6 py-3 rounded-xl shadow-lg transition-transform duration-300 hover:scale-105 hover:shadow-2xl"
                data-aos="fade-up"
            >
                Cliquez ici
            </button>
